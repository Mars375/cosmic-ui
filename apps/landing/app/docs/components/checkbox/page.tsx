    ...
    <div className="min-h-screen bg-cosmic-background text-cosmic-foreground">
      <div className="container mx-auto px-4 py-8">
        ...
        <p className="text-lg text-cosmic-muted mb-8">
          Le composant Checkbox permet aux utilisateurs de sélectionner une ou plusieurs options 
          dans une liste. Il supporte les états cochés, non cochés et désactivés.
        </p>
...
export default function MyComponent() {
  return (
    <div className="space-y-4">
      ...
      <Checkbox id="option2" label="Option 2" description="Description de l'option 2" />
      <Checkbox id="option3" label="Option désactivée" disabled />
    </div>
  );
}`, 'usage')}>
{`import { Checkbox } from '@cosmic-ui/components';
    ...
    <div className="space-y-4">
      ...
      <Checkbox id="option3" label="Option désactivée" disabled />
        ...
        <div className="mb-12">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-4 mb-4">
              <h3 className="text-lg font-medium">Avec description</h3>
              <div className="flex bg-cosmic-surface rounded-lg p-1">
                <button
                  onClick={() => setShowCode(false)}
                  className={`px-3 py-1 rounded text-sm transition-colors ${
...
export default function MyComponent() {
  return (
    ...
    />
          ...
          <div className="mb-8">
            <div className="flex items-center gap-4 mb-4">
              <h3 className="text-lg font-medium">État désactivé</h3>
              <div className="flex bg-cosmic-surface rounded-lg p-1">
                <button
                  onClick={() => setShowCode(false)}
                  className={`px-3 py-1 rounded text-sm transition-colors ${
