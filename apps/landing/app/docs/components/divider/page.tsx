...
import { Divider } from 'cosmic-ui-mars';
    ...
    <div className="container max-w-6xl mx-auto px-4 py-8">
      ...
      <div className="mb-12">
        ...
        <p className="text-xl text-muted-foreground max-w-3xl">
          Un composant séparateur pour organiser le contenu.
        </p>
      </div>
      ...
      <div className="mb-12">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <CodeBlock
              language="typescript"
              filePath="components/DividerExample.tsx"
        ...
        <div className="space-y-8">
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div>
              <CodeBlock
                language="typescript"
                filePath="components/Divider1.tsx"
                showPackageManager={false}
              >
                {`export default function App\docs\components\divider\page.tsxExample() {
  return <Divider />;
}`}
              </CodeBlock>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div>
              <CodeBlock
                language="typescript"
                filePath="components/Divider2.tsx"
                showPackageManager={false}
              >
                {`export default function App\docs\components\divider\page.tsxExample() {
  return <Divider />;
      ...
      <div className="mb-12">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div>
            <CodeBlock
              language="typescript"
              filePath="components/InteractiveDivider.tsx"
              showPackageManager={false}
            >
              {`export default function App\docs\components\divider\page.tsxExample() {
