    ...
    <div className="min-h-screen bg-cosmic-background text-cosmic-foreground">
      <div className="container mx-auto px-4 py-8">
        ...
        <p className="text-lg text-cosmic-muted mb-8">
          Le composant Modal affiche du contenu dans une fenêtre superposée, 
          idéal pour les formulaires, confirmations et contenus contextuels.
        </p>
  ...
  return (
    <Modal open={isOpen} onOpenChange={setIsOpen}>
      <ModalHeader>
        ...
        <ModalDescription>Description optionnelle</ModalDescription>
      </ModalHeader>
      <ModalContent>
    ...
    <Modal open={isOpen} onOpenChange={setIsOpen}>
      ...
      <ModalFooter>
        ...
        <div className="mb-12">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-4 mb-4">
              <h3 className="text-lg font-medium">Modale simple</h3>
              <div className="flex bg-cosmic-surface rounded-lg p-1">
                <button
                  onClick={() => setShowCode(false)}
                  className={`px-3 py-1 rounded text-sm transition-colors ${
            ...
            <div className="w-[500px] h-[450px] border border-cosmic-border rounded-lg bg-cosmic-surface p-2 flex justify-start">
              {!showCode ? (
                <div className="p-4">
                  ...
                  <Modal open={isOpen} onOpenChange={setIsOpen}>
                    <ModalContent>
                      <p>Contenu simple de la modale</p>
                    </ModalContent>
                  </Modal>
                </div>
              ) : (
