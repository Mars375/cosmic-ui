    ...
    <div className="container max-w-6xl mx-auto px-4 py-8">
      ...
      <div className="mb-12">
        ...
        <p className="text-xl text-muted-foreground max-w-3xl">
          Un composant de menu de navigation avec support des sous-menus.
        </p>
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          <div className="space-y-4">
            ...
            <div className="p-6 bg-muted/30 rounded-lg border">
              <NavigationMenu>Contenu du composant</NavigationMenu>
            </div>
          </div>
          <div>
            ...
            <CodeBlock
              language="typescript"
              filePath="components/NavigationMenuExample.tsx"
        ...
        <div className="space-y-8">
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div>
              <CodeBlock
                language="typescript"
                filePath="components/NavigationMenu1.tsx"
                showPackageManager={false}
              >
