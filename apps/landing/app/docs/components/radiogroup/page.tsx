...
import { RadioGroup } from 'cosmic-ui-mars';
    ...
    <div className="container max-w-6xl mx-auto px-4 py-8">
      ...
      <div className="mb-12">
        ...
        <p className="text-xl text-muted-foreground max-w-3xl">
          Un composant groupe de boutons radio pour les sélections uniques.
        </p>
      </div>
  ...
  Contenu du composant
      ...
      <div className="mb-12">
        ...
        <div className="space-y-8">
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            <div className="space-y-4">
              <h3 className="text-lg font-medium text-foreground">Groupe radio avec description</h3>
            ...
            <div>
              <CodeBlock language="typescript" filePath="components/RadioGroup1.tsx" showPackageManager={false}>
  ...
  Contenu du composant
      ...
      <div className="mb-12">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div>
            <CodeBlock language="typescript" filePath="components/InteractiveRadioGroup.tsx" showPackageManager={false}>
{`export default function App\docs\components\radiogroup\page.tsxExample() {
