...
import { Spinner } from '@cosmic-ui/components';
    ...
    <div className="min-h-screen bg-cosmic-background text-cosmic-foreground">
      <div className="container mx-auto px-4 py-8">
        ...
        <p className="text-lg text-cosmic-muted mb-8">
          Le composant Spinner affiche un indicateur de chargement animé, 
          indiquant qu'une opération est en cours d'exécution.
        </p>
          ...
          <div className="w-[500px] h-[450px] border border-cosmic-border rounded-lg bg-cosmic-surface p-2 flex justify-start">
            {!showCode ? (
              ...
              <div className="w-full h-full bg-white dark:bg-black p-2 rounded">
                <CodeBlock onCopy={() => copyToClipboard(`import { Spinner } from '@cosmic-ui/components';
    ...
    <div className="flex items-center justify-center p-8">
      <Spinner size={24} color="#3b82f6" />
        ...
        <div className="mb-12">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-4 mb-4">
              <h3 className="text-lg font-medium">Différentes tailles</h3>
              <div className="flex bg-cosmic-surface rounded-lg p-1">
                <button
                  onClick={() => setShowCode(false)}
                  className={`px-3 py-1 rounded text-sm transition-colors ${
              ...
              {!showCode ? (
                <div className="p-4 w-full">
                  <div className="flex items-center justify-center space-x-8">
                    ...
                    <div className="text-center">
                      <Spinner size={48} />
                      <p className="text-xs mt-2">Très grand</p>
                    </div>
                  </div>
                </div>
              ) : (
