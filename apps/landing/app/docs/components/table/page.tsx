...
import { Table } from 'cosmic-ui-mars';
    ...
    <div className="container max-w-6xl mx-auto px-4 py-8">
      ...
      <div className="mb-12">
        ...
        <p className="text-xl text-muted-foreground max-w-3xl">
          Un composant table pour afficher des données structurées.
        </p>
      </div>
      ...
      <div className="mb-12">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <CodeBlock language="typescript" filePath="components/TableExample.tsx" showPackageManager={false}>
{`import { Table } from 'cosmic-ui-mars';
  ...
  Contenu du composant
      ...
      <div className="mb-12">
        ...
        <div className="space-y-8">
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            <div className="space-y-4">
              <h3 className="text-lg font-medium text-foreground">Table avec tri</h3>
            ...
            <div>
              <CodeBlock language="typescript" filePath="components/Table1.tsx" showPackageManager={false}>
{`export default function App\docs\components\table\page.tsxExample() {
  <Table>
  Contenu du composant
</Table>
}`}
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            <div className="space-y-4">
              <h3 className="text-lg font-medium text-foreground">Table avec pagination</h3>
              <p className="text-muted-foreground">Description du variant</p>
              <div className="p-6 bg-muted/30 rounded-lg border">
                <Table>
                  Contenu du composant
            ...
            <div>
              <CodeBlock language="typescript" filePath="components/Table2.tsx" showPackageManager={false}>
{`export default function App\docs\components\table\page.tsxExample() {
  <Table>
  Contenu du composant
</Table>
      ...
      <div className="mb-12">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div>
            <CodeBlock language="typescript" filePath="components/InteractiveTable.tsx" showPackageManager={false}>
{`export default function App\docs\components\table\page.tsxExample() {
