    ...
    <div className="min-h-screen bg-cosmic-background text-cosmic-foreground">
      <div className="container mx-auto px-4 py-8">
        ...
        <p className="text-lg text-cosmic-muted mb-8">
          Le composant Toast affiche des notifications temporaires pour informer l'utilisateur 
          des actions réussies, erreurs ou autres messages importants.
        </p>
            ...
            {!showCode ? (
              <div className="p-4 w-full">
                <Toast>
                  ...
                  <ToastAction altText="Fermer">
                    <Button size="sm" variant="outline">Fermer</Button>
                  </ToastAction>
                  <ToastClose />
                </Toast>
              </div>
    ...
    <>
      ...
      <ToastViewport />
        ...
        <div className="mb-12">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-4 mb-4">
              <h3 className="text-lg font-medium">Toast simple</h3>
              <div className="flex bg-cosmic-surface rounded-lg p-1">
                <button
                  onClick={() => setShowCode(false)}
                  className={`px-3 py-1 rounded text-sm transition-colors ${
