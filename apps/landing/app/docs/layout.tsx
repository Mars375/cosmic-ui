...
const docsNavigation: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/docs/theme-system', label: 'Système de thèmes' },
      { href: '/docs/customization', label: 'Personnalisation' },
      { href: '/docs/colors', label: 'Système de couleurs' },
      { href: '/docs/components', label: "Vue d'ensemble des composants" },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/docs/components/input-mask', label: 'InputMask' },
      { href: '/docs/components/input-otp', label: 'InputOTP' },
      {
        href: '/docs/components/calendar-date-picker',
        label: 'CalendarDatePicker',
      },
      { href: '/docs/components/form-rhf', label: 'FormRHF' },
    ],
  },
  {
    label: 'Navigation',
    items: [
      ...
      { href: '/docs/components/step-wizard', label: 'StepWizard' },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/docs/components/heatmap-calendar', label: 'HeatmapCalendar' },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/docs/components/file-explorer', label: 'FileExplorer' },
      { href: '/docs/components/rich-text-editor', label: 'RichTextEditor' },
      { href: '/docs/components/markdown-renderer', label: 'MarkdownRenderer' },
      { href: '/docs/components/code-block', label: 'CodeBlock' },
      { href: '/docs/components/kanban-board', label: 'KanbanBoard' },
      { href: '/docs/components/pricing-table', label: 'PricingTable' },
      { href: '/docs/components/timeline', label: 'Timeline' },
      { href: '/docs/components/auth-pages', label: 'Auth Pages' },
      { href: '/docs/components/team-management', label: 'TeamManagement' },
      { href: '/docs/components/user-profile', label: 'UserProfile' },
      { href: '/docs/components/debug-panel', label: 'Debug Panel' },
    ],
  },
  {
    label: 'Accessibilité & Thèmes',
    items: [
      { href: '/docs/components/a11y-helpers', label: 'A11y Helpers' },
      { href: '/docs/components/theme-switcher', label: 'ThemeSwitcher' },
      { href: '/docs/components/i18n-switcher', label: 'I18n Switcher' },
    ],
  },
];
